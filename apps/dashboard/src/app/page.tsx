...
export default function ChatPage() {
  ...
  return (
    <div className="relative flex min-h-0 flex-1 flex-col overflow-hidden">
              ...
              >
                <div
                  className={`relative max-w-[80%] rounded-lg px-3 py-2 text-sm shadow-sm sm:max-w-[65%] ${
                    isUser
                      ? "bubble-tail-out bg-[#d9fdd3] text-gray-900 dark:bg-[#005c4b] dark:text-white"
                      : "bubble-tail-in bg-white text-gray-900 dark:bg-[#202c33] dark:text-white"
                  }`}
                >
                  {m.kind === "voice" ? (
      ...
      <div className="border-t border-black/10 bg-[#f0f2f5] p-3 dark:border-white/10 dark:bg-[#1f2c34]">
        <div className="mx-auto max-w-2xl">
          {isRecording ? (
            <div className="flex items-center gap-3">
              ...
              <div className="flex min-w-0 flex-1 items-center gap-2 rounded-full bg-white px-4 py-2.5 text-sm dark:bg-[#2a3942]">
              ...
              <button
                ...
                title="Send"
                className="shrink-0 rounded-full bg-[#00a884] p-2.5 text-white hover:bg-[#029773]"
              >
                <SendIcon />
              </button>
            </div>
            ...
            <form onSubmit={handleTextSubmit} className="flex items-center gap-2">
              <input
                ...
                disabled={loading}
                className="flex-1 rounded-full border border-transparent bg-white px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#00a884] dark:bg-[#2a3942] dark:text-white"
              />
              <button
                type="button"
                ...
                className="shrink-0 rounded-full bg-[#00a884] p-2.5 text-white hover:bg-[#029773] disabled:opacity-40"
              >
      ...
      <Link
        href="/admin"
        className="absolute bottom-1.5 right-2 z-10 text-[10px] text-black/25 hover:text-black/50 dark:text-white/25 dark:hover:text-white/50"
      >
        Admin
      </Link>
    </div>
...
function TypingBubble() {
  return (
    <div className="flex justify-start">
      <div className="bubble-tail-in flex items-center gap-1 rounded-lg bg-white px-3 py-3 shadow-sm dark:bg-[#202c33]">
